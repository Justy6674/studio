...
exports.fetchHydrationLogs = void 0;
/**
...
exports.fetchHydrationLogs = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    const startDate = (0, date_fns_1.startOfDay)((0, date_fns_1.subDays)(today, daysToFetch - 1)); // e.g., for 7 days, it's 6 days ago to include today
...
//# sourceMappingURL=fetchHydrationLogs.js.map