...
- **AI-Powered Motivation**: Daily motivational messages generated by Gemini AI with customizable tone
- **SMS Reminders**: Scheduled Twilio SMS with customisable tone preferences (limited to 2/day)
- **Streak Tracking**: Daily and longest streak monitoring with celebrations
...
- **Badge System**: Gamification with unlockable achievements for hydration milestones
- **Celebrations**: Visual celebrations at 50% and 100% hydration goals with confetti
- **Body Metrics**: Track weight and waist measurements over time
- **Pull-to-Refresh**: Mobile-friendly data refresh on all main pages
- **Interactive Charts**: Time-based visualization with trend indicators
- **Export Feature**: Export hydration history as PDF
