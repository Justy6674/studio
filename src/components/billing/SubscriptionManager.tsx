...
import { Check, Crown, Droplets, Zap, MessageCircle, Phone } from 'lucide-react';
    ...
    <div className={`max-w-4xl mx-auto ${className}`}>
      <div className="text-center mb-8">
        ...
        <p className="text-white/70 max-w-2xl mx-auto">
          Unlock AI-powered insights and personalized coaching to accelerate your weight loss through proper hydration
        </p>
      </div>
        ...
        <Card className={`border-2 ${isPremium ? 'border-[#5271ff] bg-[#5271ff]/5' : 'border-[#5271ff]/50'} bg-[#1e293b] relative overflow-hidden`}>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-white flex items-center gap-2">
                  <Crown className="w-5 h-5 text-[#5271ff]" />
                  Premium Hydration
                </CardTitle>
                <CardDescription className="text-white/70">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-[#5271ff]/10 border border-[#5271ff]/30 rounded-lg p-3">
                ...
                <div className="text-white/60 text-xs">Personalized daily motivation</div>
              </div>
              <div className="bg-[#5271ff]/10 border border-[#5271ff]/30 rounded-lg p-3">
              ...
              <div className="bg-[#5271ff]/10 border border-[#5271ff]/30 rounded-lg p-3">
                <Crown className="w-6 h-6 text-[#5271ff] mb-2" />
