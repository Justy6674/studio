// Spacing system for Water4WeightLoss
...
export function getBorderRadius(size: BorderRadius = 'DEFAULT'): string {
  return borderRadius[size];
}

export function getBorderWidth(width: BorderWidth = 'DEFAULT'): string {
